...
public class SilverSearchDetails {
	...
	public SilverSearchDetails(int seach_seq, int type, String areaa, String areab, String areac, String silvername,
	...
	public String toString() {
		return "SilverSearchDetails [seach_seq=" + seach_seq + ", type=" + type + ", areaa=" + areaa + ", areab="
				+ areab + ", areac=" + areac + ", silvername=" + silvername + ", service=" + service + ", grade="
				+ grade + ", lauitude=" + lauitude + ", longitude=" + longitude + ", detail_seq=" + detail_seq
